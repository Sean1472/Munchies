...
public class Main extends JavaPlugin {
    ...
    public List<ShapedRecipe> generateShapedRecipes() {
        ...
        //cheese sword
        ShapedRecipe sword = new ShapedRecipe(new NamespacedKey(plugin, "bagel"), Items.CHEESE_SWORD.getItem());
        sword.shape("a", "a", "b");
    ...
    public List<ShapelessRecipe> generateShapelessRecipes() {
        ...
        //fish and chips
        ShapelessRecipe fish = new ShapelessRecipe(new NamespacedKey(plugin, "french_fries"), Items.FISH_AND_CHIPS.getItem());
        ...
        //cocoa powder
        ShapelessRecipe cocoa = new ShapelessRecipe(new NamespacedKey(plugin, "cumin_powder"), Items.COCOA_POWDER.getItem());
        cocoa.addIngredient(Material.COCOA_BEANS);
        cocoa.addIngredient(new RecipeChoice.ExactChoice(Items.MORTAR_AND_PESTLE.getItem()));
        recipes.add(cocoa);

        //chocolate
        ShapelessRecipe chocolate = new ShapelessRecipe(new NamespacedKey(plugin, "cumin_powder"), Items.CHOCOLATE.getItem());
    ...
    public List<FurnaceRecipe> generateFurnaceRecipes() {
        ...
        //raisins
        recipes.add(new FurnaceRecipe(new NamespacedKey(plugin, "cheese"), Items.CHEESE.getItem(), new RecipeChoice.ExactChoice(Items.GRAPES.getItem()), 0.35F, 240));
