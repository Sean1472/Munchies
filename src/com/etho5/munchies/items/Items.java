...
public enum Items {
    ...
    KNIFE("Knife", 62, Material.WOODEN_SWORD),
    ALMONDS("Almonds", 63, Material.POTATO),
    PECANS("Pecans", 64, Material.POTATO),
    TURMERIC("Turmeric", 65),
    CUMIN("Cumin", 66),
    CHILI_PEPPER("Chili Pepper", 67, Material.SALMON),
    ...
    TOMATO("Tomato", 74, Material.SALMON),
    TOMATO_PASTE("Tomato Paste", 75),
    CURRY("Curry", 76, Material.MUSHROOM_STEW),
    CAN("Can", 77),
    COLEANS("Coleans", 78, Material.SUSPICIOUS_STEW),
    ...
    CHEESE_SWORD("Cheese Sword", 98, Material.WOODEN_SWORD),
    HAMBURGER("Hamburger", 99, Material.COOKED_BEEF),
    CHEESEBURGER("Cheeseburger", 100, Material.COOKED_BEEF),
    SCRAMBLED_EGGS("Scrambled Eggs", 101, Material.CHICKEN),
    ...
    CHOCOLATE("Chocolate", 108, Material.CARROT),
